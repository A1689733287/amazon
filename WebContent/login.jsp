...
<script type="text/javascript"
	src="${pageContext.request.contextPath}/scripts/md5.min.js"></script>
</head>
<body>
				...
				<form id="loginForm" method="post" action="login"
					...
					<table>
						...
						<tr>
							...
							<td class="td"><input class="text" type="password"
								id="passWord" name="passWord" onfocus="FocusItem(this)"
								onblur="CheckItem(this);" /><a href="retrieve_password.jsp">忘记密码</a><span></span></td>
						...
						<tr>
							...
							<td><input class="text verycode" type="text" name="veryCode"
								...
								maxlength="4" /><img id="veryCode" src="imageCode"
								onclick="changeCode(this);" /><span id="Code"></span></td>
						</tr>
						<tr>
							<td></td>
	...
	<div id="footer">Copyright &copy; 2018 上海海文 All Rights Reserved</div>
</body>
</html>
