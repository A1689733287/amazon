<%@page import="com.gpg.amazon.entity.News"%>
...
<body>
	...
	<div id="position" class="wrap">
		您现在的位置：<a href="index">亚马逊</a> &gt; 阅读新闻
	</div>
	<div id="main" class="wrap">
		...
		<div id="news" class="right-main">
			<h1>标题:${requestScope.news.news_title }</h1>
			<div class="content">
				<p style="text-align: right;">创建时间：${requestScope.news.news_create_time }</p>
				内容：${requestScope.news.news_content }
			</div>
		</div>
		<div class="clear"></div>
	</div>
